...
defaultproperties
{
     ...
     items(3)=(HelpText="Randomises the skins of miscellaneous junk around the maps, like couches, chairs, etc.",actionText="Randomise Decorations",variable="bRandomizeCrap");
