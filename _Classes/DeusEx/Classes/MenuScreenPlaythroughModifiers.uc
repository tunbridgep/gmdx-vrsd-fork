...
defaultproperties
{
     ...
     items(4)=(HelpText="Shuffles the order of aug canisters in the game. Total number of each aug canister type is unchanged. Fully Random shuffles their order of appearance. Semi-Random guarantees that all unique augs are obtainable up until Versalife Level 2 Labs as in Vanilla.",actionText="Aug Canister Shuffle",variable="iAugShuffleMode",valueText1="Fully Randomized Order", valueText2="Semi-Randomized Order");
