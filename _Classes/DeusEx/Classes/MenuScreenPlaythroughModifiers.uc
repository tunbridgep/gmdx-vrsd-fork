...
defaultproperties
{
     ...
     modifierDesc(3)="Swaps around enemies in each map, to create more dynamic and unique encounters. Total enemy numbers are unchanged."
