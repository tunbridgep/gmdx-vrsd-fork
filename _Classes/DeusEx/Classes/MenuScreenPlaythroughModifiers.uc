...
defaultproperties
{
     ...
     items(4)=(HelpText="Shuffles the order of aug canisters in the game. Total number of each aug canister type is unchanged. Semi-random allows to get the full kit at Versalife Level 2 Labs as in Vanilla.",actionText="Aug Canister Shuffle",variable="iAugShuffleMode",valueText1="Randomized Order", valueText2="Semi-Randomized Order");
