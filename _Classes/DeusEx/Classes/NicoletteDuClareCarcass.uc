...
defaultproperties
{
     ...
     HDTPMeshTex(3)="HDTPCharacters.Skins.HDTPNicoletteTex3"
     HDTPMeshTex(4)="HDTPCharacters.Skins.HDTPNicoletteTex4"
     HDTPMeshTex(5)="HDTPCharacters.Skins.HDTPNicoletteTex5"
     HDTPMeshTex(6)="HDTPCharacters.Skins.HDTPNicoletteTex6"
     HDTPMeshTex(7)="HDTPCharacters.Skins.HDTPNicoletteTex7"
