//=============================================================================
// ColorThemeHUD_WildBerry
//=============================================================================

class ColorThemeHUD_WildBerry extends ColorThemeHUD;
...
defaultproperties
{
    themeName="Wild Berry"
    bSystemTheme=True
    Colors(0)=(R=8,G=0,B=20,A=0)
    Colors(1)=(R=75,G=0,B=255,A=0)
    Colors(2)=(R=0,G=255,B=255,A=0)
    Colors(3)=(R=15,G=0,B=50,A=0)
    Colors(4)=(R=125,G=0,B=255,A=0)
    Colors(5)=(R=0,G=255,B=255,A=0)
    Colors(6)=(R=20,G=0,B=60,A=0)
    Colors(7)=(R=0,G=255,B=255,A=0)
    Colors(8)=(R=0,G=200,B=200,A=0)
    Colors(9)=(R=0,G=200,B=200,A=0)
    Colors(10)=(R=0,G=255,B=255,A=0)
    Colors(11)=(R=15,G=0,B=50,A=0)
    Colors(12)=(R=0,G=255,B=255,A=0)
    Colors(13)=(R=75,G=0,B=255,A=0)
}
