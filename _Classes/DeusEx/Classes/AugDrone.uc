...
{
    //Destroy the drone if we activate it on zero energy
...
defaultproperties
{
     ...
     GroundedMessage="You must have stable footing to construct the drone"
     GroundedMessage2="You must have stable footing to resume control of the drone"
