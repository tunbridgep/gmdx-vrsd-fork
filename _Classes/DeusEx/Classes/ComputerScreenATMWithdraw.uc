...
var MenuUIActionButtonWindow btnWithdrawAll;
...
var localized String ButtonLabelWithdrawAll;
...
function WithdrawCredits(optional bool bWithdrawAll)
{
    ...
    {
        if (winTerm.bHacked)
			numCredits  = atmOwner.GetBalance(-1, balanceModifier);
		else
			numCredits  = atmOwner.GetBalance(winTerm.GetUserIndex(), balanceModifier);
    }
    else
...
defaultproperties
{
     ...
     ButtonLabelWithdrawAll="Withdraw |&All"
