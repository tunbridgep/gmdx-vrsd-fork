...
defaultproperties
{
    ...
    bSystemTheme=True
    Colors(0)=(R=10,G=10,B=10)
    Colors(1)=(R=30,G=30,B=30)
    Colors(2)=(R=255,G=255,B=0)
    Colors(3)=(R=15,G=15,B=15)
    Colors(4)=(R=60,G=60,B=60)
    Colors(5)=(R=255,G=255,B=0)
    Colors(6)=(R=64,G=64,B=64)
    Colors(7)=(R=255,G=255,B=0)
    Colors(8)=(R=200,G=200,B=0)
    Colors(9)=(R=200,G=200,B=0)
    Colors(10)=(R=255,G=255,B=0)
    Colors(11)=(R=10,G=10,B=10)
    Colors(12)=(R=100,G=100,B=100)
    Colors(13)=(R=100,G=100,B=100)
}
