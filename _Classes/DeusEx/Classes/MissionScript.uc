...
function SetRainLevel()
{
    ...
    player.precipDensity = FMAX(0.0,player.precipDensity);
    player.precipDensity = FMIN(14.0,player.precipDensity);
    ...
    foreach AllActors(class'PrecipitationInfoBase', precips)
    {
        ...
        precips.bSplashyFeet = player.precipDensity >= 7;
        if (player.precipDensity < 3.5)
            precips.PrecipNoise = None;
        else
            precips.PrecipNoise = precips.default.PrecipNoise;
        precips.UpdatePrecipitationSettings();
    }
