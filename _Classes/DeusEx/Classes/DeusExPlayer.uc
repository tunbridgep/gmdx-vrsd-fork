...
var travel int iAugShuffleMode;                                                 //Ivan Kenobi: 0 = Original Aug Canister order, 1 = Fully Random Shuffle, 2 = Random Shuffle that guarantees all unique augs spawn up until VersaLife Level 2 Labs as in Vanilla
