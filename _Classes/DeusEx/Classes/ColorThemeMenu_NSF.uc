...
class ColorThemeMenu_NSF extends ColorThemeHUD;
...
defaultproperties
{
    themeName="NSF"
    bSystemTheme=True
    Colors(0)=(R=225,G=180,B=130,A=0)
    Colors(1)=(R=225,G=180,B=130,A=0)
    Colors(2)=(R=200,G=200,B=200,A=0)
    Colors(3)=(R=200,G=200,B=200,A=0)
    Colors(4)=(R=200,G=200,B=200,A=0)
    Colors(5)=(R=255,G=130,B=0,A=0)
    Colors(6)=(R=150,G=150,B=150,A=0)
    Colors(7)=(R=200,G=200,B=200,A=0)
    Colors(8)=(R=200,G=200,B=200,A=0)
    Colors(9)=(R=255,G=130,B=0,A=0)
    Colors(10)=(R=75,G=75,B=75,A=0)
    Colors(11)=(R=150,G=150,B=150,A=0)
    Colors(12)=(R=255,G=130,B=0,A=0)
