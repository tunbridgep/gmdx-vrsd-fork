...
defaultproperties
{
     ...
     datacubeTitles(92)=(textTag="DeusExText.11_Datacube02",replacement="Morpheus")
     datacubeTitles(93)=(textTag="DeusExText.11_Datacube03",replacement="Orders")
     datacubeTitles(94)=(textTag="DeusExText.12_Datacube02",replacement="Saddle Up (Draft)")
     datacubeTitles(95)=(textTag="DeusExText.14_Datacube01",replacement="Message for Nasir")
     datacubeTitles(96)=(textTag="DeusExText.14_Datacube02",replacement="Tunnel Code")
     datacubeTitles(97)=(textTag="DeusExText.14_Datacube05",replacement="Security Login")
     datacubeTitles(98)=(textTag="DeusExText.14_Datacube06",replacement="Ridley's Betrayal")
     datacubeTitles(99)=(textTag="DeusExText.15_Datacube01",replacement="Message for Julia")
     datacubeTitles(100)=(textTag="DeusExText.15_Datacube09",replacement="Coolant Door Lock")
     datacubeTitles(101)=(textTag="DeusExText.15_Datacube11",replacement="Message for Alain")
     datacubeTitles(102)=(textTag="DeusExText.15_Datacube12",replacement="Explosives")
     datacubeTitles(103)=(textTag="DeusExText.15_Datacube17",replacement="Security Login")
     datacubeTitles(104)=(textTag="DeusExText.15_Datacube18",replacement="Lab 12 Testing Regimen")
     datacubeTitles(105)=(textTag="DeusExText.15_Datacube19",replacement="Reactor Leak")
     datacubeTitles(106)=(textTag="DeusExText.15_Datacube20",replacement="Get Topside!")
     //Training
     datacubeTitles(107)=(textTag="DeusExText.00_Datacube01",replacement="Door Code")
     datacubeTitles(108)=(textTag="DeusExText.00_Datacube02",replacement="Bridge Code")
     datacubeTitles(109)=(textTag="DeusExText.00_Datacube03",replacement="Quick Note")
