...
defaultproperties
{
     ...
     datacubeTitles(82)=(textTag="DeusExText.10_Datacube09",replacement="Welcome to Paris!")
     datacubeTitles(83)=(textTag="DeusExText.10_Datacube10",replacement="Message for Chad")
     datacubeTitles(84)=(textTag="DeusExText.10_Datacube11",replacement="Security Login")
     datacubeTitles(85)=(textTag="DeusExText.11_Datacube02",replacement="Morpheus")
     datacubeTitles(86)=(textTag="DeusExText.11_Datacube03",replacement="Orders")
     datacubeTitles(87)=(textTag="DeusExText.12_Datacube02",replacement="Saddle Up (Draft)")
     datacubeTitles(88)=(textTag="DeusExText.14_Datacube01",replacement="Message for Nasir")
     datacubeTitles(89)=(textTag="DeusExText.14_Datacube02",replacement="Tunnel Code")
     datacubeTitles(90)=(textTag="DeusExText.14_Datacube05",replacement="Security Login")
     datacubeTitles(91)=(textTag="DeusExText.14_Datacube06",replacement="Ridley's Betrayal")
     datacubeTitles(92)=(textTag="DeusExText.15_Datacube01",replacement="Message for Julia")
     datacubeTitles(93)=(textTag="DeusExText.15_Datacube09",replacement="Coolant Door Lock")
     datacubeTitles(94)=(textTag="DeusExText.15_Datacube11",replacement="Message for Alain")
     datacubeTitles(95)=(textTag="DeusExText.15_Datacube12",replacement="Explosives")
     datacubeTitles(96)=(textTag="DeusExText.15_Datacube17",replacement="Security Login")
     datacubeTitles(97)=(textTag="DeusExText.15_Datacube18",replacement="Lab 12 Testing Regimen")
     datacubeTitles(98)=(textTag="DeusExText.15_Datacube19",replacement="Reactor Leak")
     datacubeTitles(99)=(textTag="DeusExText.15_Datacube20",replacement="Get Topside!")
     datacubeTitles(100)=(textTag="DeusExText.00_Datacube03",replacement="Quick Note")
