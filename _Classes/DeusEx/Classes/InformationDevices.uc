...
defaultproperties
{
     ...
     datacubeTitles(62)=(textTag="DeusExText.09_Datacube02",replacement="Armory Code")
     datacubeTitles(63)=(textTag="DeusExText.09_Datacube03",replacement="Code Change")
     datacubeTitles(64)=(textTag="DeusExText.09_Datacube04",replacement="Note to Self")
     datacubeTitles(65)=(textTag="DeusExText.09_Datacube05",replacement="Message to Walton Simons (Draft)")
     datacubeTitles(66)=(textTag="DeusExText.09_Datacube06",replacement="Code Change")
     datacubeTitles(67)=(textTag="DeusExText.09_Datacube07",replacement="Note for Doctor Liu")
     datacubeTitles(68)=(textTag="DeusExText.09_Datacube08",replacement="Security Review")
     datacubeTitles(69)=(textTag="DeusExText.09_Datacube09",replacement="Security Restrictions")
     datacubeTitles(70)=(textTag="DeusExText.09_Datacube10",replacement="BlueOS Installation Log")
     datacubeTitles(71)=(textTag="DeusExText.09_Datacube12",replacement="Orders")
     datacubeTitles(72)=(textTag="DeusExText.09_Datacube13",replacement="Note to Self")
     datacubeTitles(73)=(textTag="DeusExText.09_Datacube14",replacement="Security Restrictions")
     datacubeTitles(74)=(textTag="DeusExText.10_Datacube02",replacement="Dear Nicolette")
     datacubeTitles(75)=(textTag="DeusExText.10_Datacube03",replacement="Account Security")
     datacubeTitles(76)=(textTag="DeusExText.10_Datacube04",replacement="Get Some Cash!")
     datacubeTitles(77)=(textTag="DeusExText.10_Datacube05",replacement="Account Security")
     datacubeTitles(78)=(textTag="DeusExText.10_Datacube06",replacement="To Do List")
     datacubeTitles(79)=(textTag="DeusExText.10_Datacube07",replacement="Storeroom Code")
     datacubeTitles(80)=(textTag="DeusExText.10_Datacube09",replacement="Welcome to Paris!")
     datacubeTitles(81)=(textTag="DeusExText.10_Datacube10",replacement="Message for Chad")
     datacubeTitles(82)=(textTag="DeusExText.10_Datacube11",replacement="Security Login")
     datacubeTitles(83)=(textTag="DeusExText.11_Datacube02",replacement="Morpheus")
     datacubeTitles(84)=(textTag="DeusExText.11_Datacube03",replacement="Orders")
     datacubeTitles(85)=(textTag="DeusExText.12_Datacube02",replacement="Saddle Up (Draft)")
     datacubeTitles(86)=(textTag="DeusExText.14_Datacube01",replacement="Message for Nasir")
     datacubeTitles(87)=(textTag="DeusExText.14_Datacube02",replacement="Tunnel Code")
     datacubeTitles(88)=(textTag="DeusExText.14_Datacube05",replacement="Security Login")
     datacubeTitles(89)=(textTag="DeusExText.14_Datacube06",replacement="Ridley's Betrayal")
     datacubeTitles(90)=(textTag="DeusExText.15_Datacube01",replacement="Message for Julia")
     datacubeTitles(91)=(textTag="DeusExText.15_Datacube09",replacement="Coolant Door Lock")
     datacubeTitles(92)=(textTag="DeusExText.15_Datacube11",replacement="Message for Alain")
     datacubeTitles(93)=(textTag="DeusExText.15_Datacube12",replacement="Explosives")
     datacubeTitles(94)=(textTag="DeusExText.15_Datacube17",replacement="Security Login")
     datacubeTitles(95)=(textTag="DeusExText.15_Datacube18",replacement="Lab 12 Testing Regimen")
     datacubeTitles(96)=(textTag="DeusExText.15_Datacube19",replacement="Reactor Leak")
     datacubeTitles(97)=(textTag="DeusExText.15_Datacube20",replacement="Get Topside!")
     datacubeTitles(98)=(textTag="DeusExText.00_Datacube03",replacement="Quick Note")
