...
{
    local bool bAlwaysRead, bPlayerHasImage, bPlayerHasNote;

    if (player == None)
        player = DeusExPlayer(GetPlayerPawn());

    //Check if we should be auto-read
    if (imageClass == None && textTag == '')
        bAlwaysRead = true;

    //If relevant, check the player.
    if (!bAlwaysRead && player != None && !bIndividual)
    {
        bPlayerHasNote = player.GetNote(textTag) != None;
        bPlayerHasImage = player.FindInventoryType(imageClass) != None;
    }

    return bRead || bAlwaysRead || (bPlayerHasNote && bPlayerHasImage);
}
...
<<<<<<< Updated upstream
     ...
     datacubeTitles(32)=(textTag="DeusExText.05_Datacube07",replacement="Surgical Pre-Evaluation - Subject: Paul Denton")
     datacubeTitles(33)=(textTag="DeusExText.05_Datacube08",replacement="Logins/Passwords Request")
     datacubeTitles(34)=(textTag="DeusExText.05_Datacube09",replacement="Janine's Bots - Page Bravo-3 Peacebringer")
     datacubeTitles(35)=(textTag="DeusExText.05_Datacube10",replacement="Prospectus - Series P Agents")
     datacubeTitles(36)=(textTag="DeusExText.06_Datacube01",replacement="Hong Kong Challenges")
     datacubeTitles(37)=(textTag="DeusExText.06_Datacube02",replacement="Security Code Reset")
     datacubeTitles(38)=(textTag="DeusExText.06_Datacube03",replacement="Re: Triad Report")
     datacubeTitles(39)=(textTag="DeusExText.06_Datacube04",replacement="Surveillance Report - Triads")
     datacubeTitles(40)=(textTag="DeusExText.06_Datacube05",replacement="I'm Sorry!")
     datacubeTitles(41)=(textTag="DeusExText.06_Datacube06",replacement="Interrogation Recording")
     datacubeTitles(42)=(textTag="DeusExText.06_Datacube08",replacement="VersaLife Sign-In")
     datacubeTitles(43)=(textTag="DeusExText.06_Datacube09",replacement="I Think Something is Going On")
     datacubeTitles(44)=(textTag="DeusExText.06_Datacube10",replacement="Security System Access")
     datacubeTitles(45)=(textTag="DeusExText.06_Datacube11",replacement="Corrupted Security Upgrade")
     datacubeTitles(46)=(textTag="DeusExText.06_Datacube12",replacement="New Server Node")
     datacubeTitles(47)=(textTag="DeusExText.06_Datacube13",replacement="Police Substation Code")
     datacubeTitles(48)=(textTag="DeusExText.06_Datacube14",replacement="Message to Party Leader Xan")
     datacubeTitles(49)=(textTag="DeusExText.06_Datacube15",replacement="Password Change")
     datacubeTitles(50)=(textTag="DeusExText.06_Datacube18",replacement="Password Update")
     datacubeTitles(51)=(textTag="DeusExText.06_Datacube19",replacement="Incident Report - Officer Tam")
     datacubeTitles(52)=(textTag="DeusExText.06_Datacube20",replacement="Instructions for Mort")
     datacubeTitles(53)=(textTag="DeusExText.06_Datacube21",replacement="Book Recommendations")
     datacubeTitles(54)=(textTag="DeusExText.06_Datacube22",replacement="Surveillance Report - Maggie Chow")
     datacubeTitles(55)=(textTag="DeusExText.06_Datacube23",replacement="Hong Kong Network Services - New Account")
     datacubeTitles(56)=(textTag="DeusExText.06_Datacube24",replacement="Superfreighter Refit")
     datacubeTitles(57)=(textTag="DeusExText.06_Datacube25",replacement="Regression Analysis")
     datacubeTitles(58)=(textTag="DeusExText.06_Datacube29",replacement="Augmentation Canister")
     datacubeTitles(59)=(textTag="DeusExText.06_Datacube30",replacement="Note to Self")
     datacubeTitles(60)=(textTag="DeusExText.06_Datacube31",replacement="Welcome to VersaLife!")
     datacubeTitles(61)=(textTag="DeusExText.06_Datacube32",replacement="New Security Procedure")
     datacubeTitles(62)=(textTag="DeusExText.08_Datacube01",replacement="Information for All Staff")
     datacubeTitles(63)=(textTag="DeusExText.09_Datacube01",replacement="Ship Access")
     datacubeTitles(64)=(textTag="DeusExText.09_Datacube02",replacement="Armory Code")
     datacubeTitles(65)=(textTag="DeusExText.09_Datacube03",replacement="Code Change")
     datacubeTitles(66)=(textTag="DeusExText.09_Datacube04",replacement="Note to Self")
     datacubeTitles(67)=(textTag="DeusExText.09_Datacube05",replacement="Message to Walton Simons (Draft)")
     datacubeTitles(68)=(textTag="DeusExText.09_Datacube06",replacement="Code Change")
     datacubeTitles(69)=(textTag="DeusExText.09_Datacube07",replacement="Note for Doctor Liu")
     datacubeTitles(70)=(textTag="DeusExText.09_Datacube08",replacement="Security Review")
     datacubeTitles(71)=(textTag="DeusExText.09_Datacube09",replacement="Security Restrictions")
     datacubeTitles(72)=(textTag="DeusExText.09_Datacube10",replacement="BlueOS Installation Log")
     datacubeTitles(73)=(textTag="DeusExText.09_Datacube12",replacement="Orders")
     datacubeTitles(74)=(textTag="DeusExText.09_Datacube13",replacement="Note to Self")
     datacubeTitles(75)=(textTag="DeusExText.09_Datacube14",replacement="Security Restrictions")
     datacubeTitles(76)=(textTag="DeusExText.10_Datacube02",replacement="Dear Nicolette")
     datacubeTitles(77)=(textTag="DeusExText.10_Datacube03",replacement="Account Security")
     datacubeTitles(78)=(textTag="DeusExText.10_Datacube04",replacement="Get Some Cash!")
     datacubeTitles(79)=(textTag="DeusExText.10_Datacube05",replacement="Account Security")
     datacubeTitles(80)=(textTag="DeusExText.10_Datacube06",replacement="To Do List")
     datacubeTitles(81)=(textTag="DeusExText.10_Datacube07",replacement="Storeroom Code")
     datacubeTitles(82)=(textTag="DeusExText.10_Datacube08",replacement="Hacking Attempt")
     datacubeTitles(83)=(textTag="DeusExText.10_Datacube09",replacement="Welcome to Paris!")
     datacubeTitles(84)=(textTag="DeusExText.10_Datacube10",replacement="Message for Chad")
     datacubeTitles(85)=(textTag="DeusExText.10_Datacube11",replacement="Security Login")
     datacubeTitles(86)=(textTag="DeusExText.10_Datacube13",replacement="Suspension Vault")
     datacubeTitles(87)=(textTag="DeusExText.11_Datacube02",replacement="Morpheus")
     datacubeTitles(88)=(textTag="DeusExText.11_Datacube03",replacement="Orders")
     datacubeTitles(89)=(textTag="DeusExText.12_Datacube02",replacement="Saddle Up (Draft)")
     datacubeTitles(90)=(textTag="DeusExText.14_Datacube01",replacement="Message for Nasir")
     datacubeTitles(91)=(textTag="DeusExText.14_Datacube02",replacement="Tunnel Code")
     datacubeTitles(92)=(textTag="DeusExText.14_Datacube05",replacement="Security Login")
     datacubeTitles(93)=(textTag="DeusExText.14_Datacube06",replacement="Ridley's Betrayal")
     datacubeTitles(94)=(textTag="DeusExText.15_Datacube01",replacement="Message for Julia")
     datacubeTitles(95)=(textTag="DeusExText.15_Datacube09",replacement="Coolant Door Lock")
     datacubeTitles(96)=(textTag="DeusExText.15_Datacube11",replacement="Message for Alain")
     datacubeTitles(97)=(textTag="DeusExText.15_Datacube12",replacement="Explosives")
     datacubeTitles(98)=(textTag="DeusExText.15_Datacube17",replacement="Security Login")
     datacubeTitles(99)=(textTag="DeusExText.15_Datacube18",replacement="Lab 12 Testing Regimen")
     datacubeTitles(100)=(textTag="DeusExText.15_Datacube19",replacement="Reactor Leak")
     datacubeTitles(101)=(textTag="DeusExText.15_Datacube20",replacement="Get Topside!")
     datacubeTitles(102)=(textTag="DeusExText.00_Datacube03",replacement="Quick Note")
=======
     datacubeTitles(10)=(textTag="DeusExText.02_Datacube06",replacement="Orders")
     datacubeTitles(11)=(textTag="DeusExText.02_Datacube07",replacement="Note from Paul")
     datacubeTitles(12)=(textTag="DeusExText.02_Datacube08",replacement="New Account Setup")
     datacubeTitles(13)=(textTag="DeusExText.02_Datacube09",replacement="Basement Code")
     datacubeTitles(14)=(textTag="DeusExText.02_Datacube10",replacement="New Office")
     datacubeTitles(15)=(textTag="DeusExText.02_Datacube11",replacement="Security Grid Online")
     datacubeTitles(16)=(textTag="DeusExText.02_Datacube13",replacement="Account Compromised")
     datacubeTitles(17)=(textTag="DeusExText.02_Datacube14",replacement="Perimeter Security")
     datacubeTitles(18)=(textTag="DeusExText.02_Datacube15",replacement="Note to Commander Grimaldi")
     datacubeTitles(19)=(textTag="DeusExText.02_Datacube16",replacement="Note to Commander Grimaldi")
     datacubeTitles(20)=(textTag="DeusExText.02_Datacube17",replacement="Note to Commander Frase")
     datacubeTitles(21)=(textTag="DeusExText.03_Datacube05",replacement="Ambrosia Delivery")
     datacubeTitles(22)=(textTag="DeusExText.03_Datacube06",replacement="Perimeter Survey")
     datacubeTitles(23)=(textTag="DeusExText.03_Datacube10",replacement="Hangar Code")
     datacubeTitles(24)=(textTag="DeusExText.03_Datacube11",replacement="Janine's Bots - Repair Bot")
     datacubeTitles(25)=(textTag="DeusExText.03_Datacube12",replacement="Helibase Computer Login")
     datacubeTitles(26)=(textTag="DeusExText.03_Datacube13",replacement="Aug Canister")
     datacubeTitles(27)=(textTag="DeusExText.04_Datacube01",replacement="Message to Paul")
     datacubeTitles(28)=(textTag="DeusExText.04_Datacube02",replacement="Security Login")
     datacubeTitles(29)=(textTag="DeusExText.04_Datacube03",replacement="Account Summary")
     datacubeTitles(30)=(textTag="DeusExText.04_Datacube04",replacement="Halon Gas")
     datacubeTitles(31)=(textTag="DeusExText.04_Datacube05",replacement="UNATCO Dossier")
     datacubeTitles(32)=(textTag="DeusExText.05_Datacube01",replacement="Intrusion Attempt")
     datacubeTitles(33)=(textTag="DeusExText.05_Datacube02",replacement="New Password")
     datacubeTitles(34)=(textTag="DeusExText.05_Datacube04",replacement="Armory Code Change")
     datacubeTitles(35)=(textTag="DeusExText.05_Datacube05",replacement="Greasel Dissection")
     datacubeTitles(36)=(textTag="DeusExText.05_Datacube07",replacement="Surgical Pre-Evaluation - Subject: Paul Denton")
     datacubeTitles(37)=(textTag="DeusExText.05_Datacube08",replacement="Logins/Passwords Request")
     datacubeTitles(38)=(textTag="DeusExText.05_Datacube09",replacement="Janine's Bots - Page Bravo-3 Peacebringer")
     datacubeTitles(39)=(textTag="DeusExText.05_Datacube10",replacement="Prospectus - Series P Agents")
     datacubeTitles(40)=(textTag="DeusExText.06_Datacube01",replacement="Hong Kong Challenges")
     datacubeTitles(41)=(textTag="DeusExText.06_Datacube02",replacement="Security Code Reset")
     datacubeTitles(42)=(textTag="DeusExText.06_Datacube03",replacement="Re: Triad Report")
     datacubeTitles(43)=(textTag="DeusExText.06_Datacube04",replacement="Surveillance Report - Triads")
     datacubeTitles(44)=(textTag="DeusExText.06_Datacube05",replacement="I'm Sorry!")
     datacubeTitles(45)=(textTag="DeusExText.06_Datacube06",replacement="Interrogation Recording")
     datacubeTitles(46)=(textTag="DeusExText.06_Datacube08",replacement="VersaLife Sign-In")
     datacubeTitles(47)=(textTag="DeusExText.06_Datacube09",replacement="I Think Something is Going On")
     datacubeTitles(48)=(textTag="DeusExText.06_Datacube10",replacement="Security System Access")
     datacubeTitles(49)=(textTag="DeusExText.06_Datacube11",replacement="Corrupted Security Upgrade")
     datacubeTitles(50)=(textTag="DeusExText.06_Datacube12",replacement="New Server Node")
     ...
     datacubeTitles(77)=(textTag="DeusExText.09_Datacube12",replacement="Orders")
     datacubeTitles(78)=(textTag="DeusExText.09_Datacube13",replacement="Note to Self")
     datacubeTitles(79)=(textTag="DeusExText.09_Datacube14",replacement="Security Restrictions")
     datacubeTitles(80)=(textTag="DeusExText.10_Datacube02",replacement="Dear Nicolette")
     datacubeTitles(81)=(textTag="DeusExText.10_Datacube03",replacement="Account Security")
     datacubeTitles(82)=(textTag="DeusExText.10_Datacube04",replacement="Get Some Cash!")
     datacubeTitles(83)=(textTag="DeusExText.10_Datacube05",replacement="Account Security")
     datacubeTitles(84)=(textTag="DeusExText.10_Datacube06",replacement="To Do List")
     datacubeTitles(85)=(textTag="DeusExText.10_Datacube07",replacement="Storeroom Code")
     datacubeTitles(86)=(textTag="DeusExText.10_Datacube08",replacement="Hacking Attempt")
     datacubeTitles(87)=(textTag="DeusExText.10_Datacube09",replacement="Welcome to Paris!")
     datacubeTitles(88)=(textTag="DeusExText.10_Datacube10",replacement="Message for Chad")
     datacubeTitles(89)=(textTag="DeusExText.10_Datacube11",replacement="Security Login")
     datacubeTitles(90)=(textTag="DeusExText.10_Datacube13",replacement="Suspension Vault")
     datacubeTitles(91)=(textTag="DeusExText.11_Datacube02",replacement="Morpheus")
     datacubeTitles(92)=(textTag="DeusExText.11_Datacube03",replacement="Orders")
     datacubeTitles(93)=(textTag="DeusExText.12_Datacube02",replacement="Saddle Up (Draft)")
     datacubeTitles(94)=(textTag="DeusExText.14_Datacube01",replacement="Message for Nasir")
     datacubeTitles(95)=(textTag="DeusExText.14_Datacube02",replacement="Tunnel Code")
     datacubeTitles(96)=(textTag="DeusExText.14_Datacube05",replacement="Security Login")
     datacubeTitles(97)=(textTag="DeusExText.14_Datacube06",replacement="Ridley's Betrayal")
     datacubeTitles(98)=(textTag="DeusExText.15_Datacube01",replacement="Message for Julia")
     datacubeTitles(99)=(textTag="DeusExText.15_Datacube09",replacement="Coolant Door Lock")
     datacubeTitles(100)=(textTag="DeusExText.15_Datacube11",replacement="Message for Alain")
     datacubeTitles(101)=(textTag="DeusExText.15_Datacube12",replacement="Explosives")
     datacubeTitles(102)=(textTag="DeusExText.15_Datacube17",replacement="Security Login")
     datacubeTitles(103)=(textTag="DeusExText.15_Datacube18",replacement="Lab 12 Testing Regimen")
     datacubeTitles(104)=(textTag="DeusExText.15_Datacube19",replacement="Reactor Leak")
     datacubeTitles(105)=(textTag="DeusExText.15_Datacube20",replacement="Get Topside!")
     datacubeTitles(106)=(textTag="DeusExText.00_Datacube03",replacement="Quick Note")
>>>>>>> Stashed changes
