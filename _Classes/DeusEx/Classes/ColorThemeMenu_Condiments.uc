//=============================================================================
// ColorThemeMenu_Condiments
//=============================================================================

class ColorThemeMenu_Condiments extends ColorThemeHUD;
...
defaultproperties
{
    ...
    Colors(1)=(R=150,G=0,B=0,A=0)
    Colors(2)=(R=200,G=200,B=0,A=0)
    Colors(3)=(R=150,G=0,B=0,A=0)
    Colors(4)=(R=150,G=150,B=0,A=0)
