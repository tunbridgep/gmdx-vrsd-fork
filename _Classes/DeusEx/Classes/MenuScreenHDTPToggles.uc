...
defaultproperties
{
     ...
     items(50)=(actionText="Faucet",consoleTarget="DeusEx.Faucet",defaultValue=1);
     items(51)=(actionText="Flag Pole",consoleTarget="DeusEx.FlagPole",defaultValue=1);
     items(52)=(actionText="Flower Pot",consoleTarget="DeusEx.Flowers",defaultValue=1);
     items(53)=(actionText="Lab Flask",consoleTarget="DeusEx.Flask",defaultValue=1);
     items(54)=(actionText="Lamp 1",consoleTarget="DeusEx.Lamp1",defaultValue=1);
     items(55)=(actionText="Lamp 2",consoleTarget="DeusEx.Lamp2",defaultValue=1);
     items(56)=(actionText="Lamp 3",consoleTarget="DeusEx.Lamp3",defaultValue=1);
     items(57)=(actionText="Liquor",consoleTarget="DeusEx.LiquorBottle",defaultValue=1);
     items(58)=(actionText="Liquor (Forty)",consoleTarget="DeusEx.Liquor40oz",defaultValue=1);
     items(59)=(actionText="Liquor (Wine)",consoleTarget="DeusEx.WineBottle",defaultValue=1);
     items(60)=(actionText="Leather Couch",consoleTarget="DeusEx.CouchLeather",defaultValue=1);
     items(61)=(actionText="Medical Kit",consoleTarget="DeusEx.MedKit",defaultValue=1);
     items(62)=(actionText="Microscope",consoleTarget="DeusEx.Microscope",defaultValue=1);
     items(63)=(actionText="Nanovirus Container",consoleTarget="DeusEx.BarrelVirus",defaultValue=1);
     items(64)=(actionText="Pillow",consoleTarget="DeusEx.Pillow",defaultValue=1);
     items(65)=(actionText="Pinball Machine",consoleTarget="DeusEx.Pinball",defaultValue=1);
     items(66)=(actionText="Plant 1",consoleTarget="DeusEx.Plant1",defaultValue=1);
     items(67)=(actionText="Plant 2",consoleTarget="DeusEx.Plant2",defaultValue=1);
     items(68)=(actionText="Plant 3",consoleTarget="DeusEx.Plant3",defaultValue=1);
     items(69)=(actionText="Retinal Scanner",consoleTarget="DeusEx.RetinalScanner",defaultValue=1);
     items(70)=(actionText="Soda Can",consoleTarget="DeusEx.SodaCan",defaultValue=1);
     items(71)=(actionText="Supply Crate (General)",consoleTarget="DeusEx.CrateBreakableMedGeneral",defaultValue=1);
     items(72)=(actionText="Supply Crate (Combat)",consoleTarget="DeusEx.CrateBreakableMedCombat",defaultValue=1);
     items(73)=(actionText="Supply Crate (Medical)",consoleTarget="DeusEx.CrateBreakableMedMedical",defaultValue=1);
     items(74)=(actionText="TNT Crate",consoleTarget="DeusEx.CrateExplosiveSmall",defaultValue=1);
     items(75)=(actionText="Telephone",consoleTarget="DeusEx.Phone",defaultValue=1);
     items(76)=(actionText="Telephone Answering Machine",consoleTarget="DeusEx.TAD",defaultValue=1);
     items(77)=(actionText="Toilet",consoleTarget="DeusEx.Toilet",defaultValue=1);
     items(78)=(actionText="Toilet (Urinal)",consoleTarget="DeusEx.Toilet2",defaultValue=1);
     items(79)=(actionText="Trashcan 1",consoleTarget="DeusEx.TrashCan1",defaultValue=1);
     items(80)=(actionText="Trashcan 2",consoleTarget="DeusEx.TrashCan2",defaultValue=1);
     items(81)=(actionText="Trashcan 3",consoleTarget="DeusEx.TrashCan3",defaultValue=1);
     items(82)=(actionText="Trashcan 4",consoleTarget="DeusEx.TrashCan4",defaultValue=1);
