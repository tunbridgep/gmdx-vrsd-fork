...
defaultproperties
{
     ...
     items(31)=(actionText="Alarm Unit",consoleTarget="DeusEx.AlarmUnit",defaultValue=1);
     items(32)=(actionText="Ambrosia Container",consoleTarget="DeusEx.BarrelAmbrosia",defaultValue=1);
     items(33)=(actionText="Barrel",consoleTarget="DeusEx.Barrel1",defaultValue=1);
     items(34)=(actionText="Barrel (Flaming)",consoleTarget="DeusEx.BarrelFire",defaultValue=1);
