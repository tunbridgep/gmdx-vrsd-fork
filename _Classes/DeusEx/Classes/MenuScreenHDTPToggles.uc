...
defaultproperties
{
     ...
     Items(2)=(actionText="Blood and Decals",defaultValue=1,consoleTarget="DeusEx.DeusExDecal")
     Items(3)=(actionText="Fragments",defaultValue=1,consoleTarget="DeusEx.DeusExFragment")
     Items(4)=(actionText="JC Denton",consoleTarget="DeusEx.DeusExPlayer")
     Items(5)=(actionText="Paul Denton",consoleTarget="DeusEx.PaulDenton")
     Items(6)=(actionText="Gunther Hermann",consoleTarget="DeusEx.GuntherHermann")
     Items(7)=(actionText="Anna Navarre",consoleTarget="DeusEx.AnnaNavarre")
     Items(8)=(actionText="Nicolette DuClare",consoleTarget="DeusEx.NicoletteDuclare")
     Items(9)=(actionText="NSF Terrorist",consoleTarget="DeusEx.Terrorist")
     Items(10)=(actionText="Riot Cop",consoleTarget="DeusEx.RiotCop")
     Items(11)=(actionText="Walton Simons",consoleTarget="DeusEx.WaltonSimons")
     Items(12)=(actionText="UNATCO Trooper",consoleTarget="DeusEx.UnatcoTroop")
     //items(13)=(actionText="MJ12 Trooper",consoleTarget="DeusEx.MJ12Troop");
     Items(13)=(actionText="Cleaner Bot",defaultValue=1,consoleTarget="DeusEx.CleanerBot")
     Items(14)=(actionText="Military Bot",defaultValue=1,consoleTarget="DeusEx.MilitaryBot")
     Items(15)=(actionText="Medical Bot",defaultValue=1,consoleTarget="DeusEx.MedicalBot")
     Items(16)=(actionText="Repair Bot",defaultValue=1,consoleTarget="DeusEx.RepairBot")
     Items(17)=(actionText="Security Bot (Large)",defaultValue=1,consoleTarget="DeusEx.SecurityBot2")
     Items(18)=(actionText="Security Bot (Small)",defaultValue=1,consoleTarget="DeusEx.SecurityBot3")
     Items(19)=(actionText="Spider Bot 1",defaultValue=1,consoleTarget="DeusEx.SpiderBot")
     Items(20)=(actionText="Spider Bot (Mini)",defaultValue=1,consoleTarget="DeusEx.SpiderBot2")
     Items(21)=(actionText="Spider Bot (Mini #2)",defaultValue=1,consoleTarget="DeusEx.SpiderBot3")
     Items(22)=(actionText="Spider Bot (Mini #3)",defaultValue=1,consoleTarget="DeusEx.SpiderBot4")
     Items(23)=(actionText="Gray",defaultValue=1,consoleTarget="DeusEx.Gray")
     Items(24)=(actionText="Greasel",defaultValue=1,consoleTarget="DeusEx.Greasel")
     Items(25)=(actionText="Karkian",defaultValue=1,consoleTarget="DeusEx.Karkian")
     Items(26)=(actionText="Auto Turret",defaultValue=1,consoleTarget="DeusEx.AutoTurret")
     Items(27)=(actionText="Assault Gun",defaultValue=1,consoleTarget="DeusEx.WeaponAssaultGun")
     Items(28)=(actionText="Assault Shotgun",defaultValue=1,consoleTarget="DeusEx.WeaponAssaultShotgun")
     Items(29)=(actionText="Baton",consoleTarget="DeusEx.WeaponBaton")
     Items(30)=(actionText="Combat Knife",defaultValue=1,consoleTarget="DeusEx.WeaponCombatKnife")
     Items(31)=(actionText="Crowbar",defaultValue=1,consoleTarget="DeusEx.WeaponCrowbar")
     Items(32)=(actionText="EMP Grenade",consoleTarget="DeusEx.WeaponEMPGrenade")
     Items(33)=(actionText="Flamethrower",defaultValue=1,consoleTarget="DeusEx.WeaponFlamethrower")
     Items(34)=(actionText="Gas Grenade",consoleTarget="DeusEx.WeaponGasGrenade")
     Items(35)=(actionText="GEP Gun",defaultValue=1,consoleTarget="DeusEx.WeaponGEPGun")
     Items(36)=(actionText="LAM",consoleTarget="DeusEx.WeaponLAM")
     Items(37)=(actionText="LAW",defaultValue=1,consoleTarget="DeusEx.WeaponLAW")
     Items(38)=(actionText="Mini-Crossbow",defaultValue=1,consoleTarget="DeusEx.WeaponMiniCrossbow")
     Items(39)=(actionText="Dragons Tooth Sword",defaultValue=1,consoleTarget="DeusEx.WeaponNanoSword")
     Items(40)=(actionText="Scramble Grenade",consoleTarget="DeusEx.WeaponNanoVirusGrenade")
     Items(41)=(actionText="Pepper Spray",defaultValue=1,consoleTarget="DeusEx.WeaponPepperGun")
     Items(42)=(actionText="Pistol",defaultValue=1,consoleTarget="DeusEx.WeaponPistol")
     Items(43)=(actionText="Plasma Rifle",defaultValue=1,consoleTarget="DeusEx.WeaponPlasmaRifle")
     Items(44)=(actionText="Riot Prod",consoleTarget="DeusEx.WeaponProd")
     Items(45)=(actionText="Sniper Rifle",valueText2="FOMOD Beta",defaultValue=1,consoleTarget="DeusEx.WeaponRifle")
     Items(46)=(actionText="Sawed-Off Shotgun",valueText2="FOMOD Beta",defaultValue=2,consoleTarget="DeusEx.WeaponSawedOffShotgun")
     Items(47)=(actionText="Stealth Pistol",valueText2="FOMOD Beta",defaultValue=1,consoleTarget="DeusEx.WeaponStealthPistol")
     Items(48)=(actionText="Sword",defaultValue=1,consoleTarget="DeusEx.WeaponSword")
     ...
     Items(177)=(actionText="10mm Ammo",defaultValue=1,consoleTarget="DeusEx.Ammo10mm")
     Items(178)=(actionText="10mm AP Ammo",defaultValue=1,consoleTarget="DeusEx.Ammo10mmAP")
     Items(179)=(actionText="20mm Ammo",defaultValue=1,consoleTarget="DeusEx.Ammo20mm")
     Items(180)=(actionText="20mm EMP Ammo",defaultValue=1,consoleTarget="DeusEx.Ammo20mmEMP")
     Items(181)=(actionText="762mm Ammo",defaultValue=1,consoleTarget="DeusEx.Ammo762mm")
     Items(182)=(actionText="3006 Ammo",defaultValue=1,consoleTarget="DeusEx.Ammo3006")
     Items(183)=(actionText="Darts",defaultValue=1,consoleTarget="DeusEx.AmmoDart")
     Items(184)=(actionText="Darts (Flare)",defaultValue=1,consoleTarget="DeusEx.AmmoDartFlare")
     Items(185)=(actionText="Darts (Poison)",defaultValue=1,consoleTarget="DeusEx.AmmoDartPoison")
     Items(186)=(actionText="Darts (Taser)",defaultValue=1,consoleTarget="DeusEx.AmmoDartTaser")
     Items(187)=(actionText="Napalm",defaultValue=1,consoleTarget="DeusEx.AmmoNapalm")
     Items(188)=(actionText="Plasma Ammo",defaultValue=1,consoleTarget="DeusEx.AmmoPlasma")
     Items(189)=(actionText="Prod Charger",defaultValue=1,consoleTarget="DeusEx.AmmoBattery")
     Items(190)=(actionText="Rockets",defaultValue=1,consoleTarget="DeusEx.AmmoRocket")
     Items(191)=(actionText="WP Rockets",defaultValue=1,consoleTarget="DeusEx.AmmoRocketWP")
