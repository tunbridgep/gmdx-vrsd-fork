...
defaultproperties
{
     ...
     items(7)=(HelpText="In Restricted mode, Combat Music will require at least 2 enemies to be in combat before music plays.",actionText="Audio: Play Combat Music",variable="iAllowCombatMusic",consoleTarget="DeusEx.MusicPlayer",defaultValue=1,valueText2="Restricted",image1="QoL_AudioCombatMusic1",image2="QoL_AudioCombatMusic2")
     ...
     items(18)=(HelpText="Always use the female hands with male JC. This setting does nothing if LDDP is not installed.",actionText="Player: Use Female Hands",variable="bFemaleHandsAlways",defaultValue=0,image1="Qol_FemaleHand1",image2="Qol_FemaleHand2")
     ...
     items(21)=(HelpText="Show darkened versions of ignored and declined items in the Items Received Window when searching carcasses.",actionText="HUD: Show Unlooted in Items Window",variable="bShowDeclinedInReceivedWindow",image1="Qol_UnlootItems1",image2="Qol_UnlootItems2")
     ...
     items(29)=(HelpText="Item icons in the Inventory and Belt will reflect item skins. Otherwise the default icon is used.",actionText="HUD: Show Skinned Icons",variable="bSkinnedBeltIcons",defaultValue=1,image1="Qol_SkinIcons1",image2="Qol_SkinIcons2")
     ...
     items(33)=(HelpText="Show rain and other weather effects. Dynamic mode adjusts the weather dynamically to simulate weather changes.",actionText="Game: Weather Effects",variable="iWeatherControl",defaultValue=1,valueText2="Dynamic (Untested!)")
     ...
     items(36)=(HelpText="If enabled, the bioenergy bar will show the reserved energy amount in red.",actionText="HUD: Show Reserved Energy",variable="bEnergyBarShowsReserve",defaultValue=1,image1="Qol_ReservedEnerg1",image2="Qol_ReservedEnerg2")
     items(37)=(HelpText="If enabled, weapons will have inertia when turning and moving.",actionText="HUD: Weapon Inertia",variable="bViewmodelInertia",defaultValue=1,image1="Qol_WpnInertia1",image2="Qol_WpnInertia2")
     items(38)=(HelpText="With Restricted Saving enabled, save points will fade out when far away from the player. Increases immersion at the cost of visibility.",actionText="Game: Fade Out Save Points",variable="bFadeOutSavePoints")
     ...
     items(40)=(HelpText="Upon acquiring a new weapon skin, it will be automatically equipped if it matches the currently held weapon.",actionText="Augmentique: Auto Equip Skins",consoleTarget="WeaponSkinManager",variable="bSwitchToNewSkins",defaultValue=1,image1="Qol_AutoSkins1",image2="Qol_AutoSkins2")
