...
defaultproperties
{
     ...
     items(37)=(HelpText="If enabled, weapons will have inertia when turning and moving.",actionText="HUD: Weapon Inertia",variable="bViewmodelInertia",defaultValue=1)
