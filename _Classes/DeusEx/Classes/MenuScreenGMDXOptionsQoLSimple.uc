...
defaultproperties
{
     ...
     items(1)=(HelpText="Enable/Disable the highlighted augmentation when closing the augmentation wheel without requiring left-click. Cancel with right click.",actionText="Augmentation Wheel: Quick Select",variable="bQuickAugWheel",image1="QoL_AugWheel_QuickSelect1",image2="QoL_AugWheel_QuickSelect2")
     ...
     items(3)=(HelpText="Enable/Disable the 'Disable All' button on the Augmentation Wheel.",actionText="Augmentation Wheel: Show 'Disable All'",variable="bAugWheelDisableAll",defaultValue=1,image1="QoL_AugWheel_DisableButton1",image2="QoL_AugWheel_DisableButton2")
     ...
     items(31)=(HelpText="Items on the Augmentation Wheel will always be in preset positions, for maintaining muscle memory.",actionText="Augmentation Wheel: Preset Positions",variable="bAugWheelPresetPositions",defaultValue=0,image1="QoL_AugWheel_PresetPositions1",image2="QoL_AugWheel_PresetPositions2")
     ...
     items(39)=(HelpText="If enabled, conversations will play in first-person rather than using a third-person camera",actionText="Player: First Person Conversations",variable="bFirstPersonConversation")
