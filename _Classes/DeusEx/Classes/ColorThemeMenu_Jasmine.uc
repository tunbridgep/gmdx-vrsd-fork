//=============================================================================
// ColorThemeMenu_Jasmine
//=============================================================================

class ColorThemeMenu_Jasmine extends ColorThemeHUD;
...
defaultproperties
{
    themeName="Jasmine"
    bSystemTheme=True
    Colors(0)=(R=127,G=255,B=212,A=0)
    Colors(1)=(R=127,G=255,B=212,A=0)
    Colors(2)=(R=255,G=255,B=0,A=0)
    Colors(3)=(R=127,G=255,B=212,A=0)
