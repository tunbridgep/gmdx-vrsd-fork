...
defaultproperties
{
    ...
    Colors(2)=(R=255,G=255,B=200)
    Colors(3)=(R=212,G=175,B=0)
    Colors(4)=(R=255,G=255,B=135)
    Colors(5)=(R=255,G=255,B=200)
    Colors(6)=(R=100,G=100,B=35)
    Colors(7)=(R=255,G=255,B=200)
    Colors(8)=(R=255,G=255,B=135)
    Colors(9)=(R=255,G=255,B=135)
    Colors(10)=(R=255,G=255,B=200)
    Colors(11)=(R=255,G=125,B=0)
    Colors(12)=(R=255,G=255,B=200)
    Colors(13)=(R=255,G=255,B=135)
}
