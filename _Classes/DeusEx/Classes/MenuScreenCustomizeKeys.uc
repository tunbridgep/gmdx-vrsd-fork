...
defaultproperties
{
     ...
     FunctionText(58)="Show Multiplayer Scores"
     FunctionText(59)="Send Message To Team"
     FunctionText(60)="Send Message To All"
     FunctionText(61)="Activate Multiplayer Skill Menu"
     FunctionText(62)="Show Multiplayer Kill Details"
     FunctionText(63)="Use Secondary Item"
     FunctionText(64)="Toggle Augmentation Wheel"
     FunctionText(65)="Hold Augmentation Wheel"
     FunctionText(66)="Stop Current Infolink"
     FunctionText(67)="Minimise Targeting/Drone Screen"
     FunctionText(68)="Select/Deselect Nano Keyring"
     FunctionText(69)="Belt Slot 1"
     FunctionText(70)="Belt Slot 2"
     FunctionText(71)="Belt Slot 3"
     FunctionText(72)="Belt Slot 4"
     FunctionText(73)="Belt Slot 5"
     FunctionText(74)="Belt Slot 6"
     FunctionText(75)="Belt Slot 7"
     FunctionText(76)="Belt Slot 8"
     FunctionText(77)="Belt Slot 9"
     FunctionText(78)="Belt Slot 10"
     FunctionText(79)="Belt Slot 11"
     FunctionText(80)="Belt Slot 12"
     FunctionText(81)="Clean Up Debris"
     ...
     AliasNames(58)="ShowScores"
     AliasNames(59)="TeamTalk"
     AliasNames(60)="Talk"
     AliasNames(61)="BuySkills"
     AliasNames(62)="KillerProfile"
     AliasNames(63)="UseSecondary"
     AliasNames(64)="ToggleRadialAugMenu"
     AliasNames(65)="HoldRadialAugMenu"
     AliasNames(66)="SkipMessages"
     AliasNames(67)="MinimiseTargetingWindow"
     AliasNames(68)="SelectNanoKey"
     AliasNames(69)="AltBelt1"
     AliasNames(70)="AltBelt2"
     AliasNames(71)="AltBelt3"
     AliasNames(72)="AltBelt4"
     AliasNames(73)="AltBelt5"
     AliasNames(74)="AltBelt6"
     AliasNames(75)="AltBelt7"
     AliasNames(76)="AltBelt8"
     AliasNames(77)="AltBelt9"
     AliasNames(78)="AltBelt0"
     AliasNames(79)="AltBelt10"
     AliasNames(80)="AltBelt11"
     AliasNames(81)="CleanUpDebris"
