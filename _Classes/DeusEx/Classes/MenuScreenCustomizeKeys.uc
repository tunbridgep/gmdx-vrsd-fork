...
var localized string	FunctionText[99];  		 //CyberP: 61
var string				MenuValues1[99]; //CyberP: 61
var string				MenuValues2[99]; //CyberP: 61
var string				AliasNames[99];  //CyberP: 61
...
defaultproperties
{
     ...
     FunctionText(55)="F11"
     FunctionText(56)="F12"
     FunctionText(57)="Flashlight Augmentation"
     FunctionText(58)="F3 (Hold)"
     FunctionText(59)="F4 (Hold)"
     FunctionText(60)="F5 (Hold)"
     FunctionText(61)="F6 (Hold)"
     FunctionText(62)="F7 (Hold)"
     FunctionText(63)="F8 (Hold)"
     FunctionText(64)="F9 (Hold)"
     FunctionText(65)="F10 (Hold)"
     FunctionText(66)="F11 (Hold)"
     FunctionText(67)="F12 (Hold)"
     FunctionText(68)="Flashlight Aug (Hold)"
     FunctionText(69)="Smart Sprint"
     FunctionText(70)="Show Multiplayer Scores"
     FunctionText(71)="Send Message To Team"
     FunctionText(72)="Send Message To All"
     FunctionText(73)="Activate Multiplayer Skill Menu"
     FunctionText(74)="Show Multiplayer Kill Details"
     FunctionText(75)="Use Secondary Item"
     FunctionText(76)="Toggle Augmentation Wheel"
     FunctionText(77)="Hold Augmentation Wheel"
     FunctionText(78)="Stop Current Infolink"
     FunctionText(79)="Minimise Targeting/Drone Screen"
     FunctionText(80)="Select/Deselect Nano Keyring"
     FunctionText(81)="Belt Slot 1"
     FunctionText(82)="Belt Slot 2"
     FunctionText(83)="Belt Slot 3"
     FunctionText(84)="Belt Slot 4"
     FunctionText(85)="Belt Slot 5"
     FunctionText(86)="Belt Slot 6"
     FunctionText(87)="Belt Slot 7"
     FunctionText(88)="Belt Slot 8"
     FunctionText(89)="Belt Slot 9"
     FunctionText(90)="Belt Slot 10"
     FunctionText(91)="Belt Slot 11"
     FunctionText(92)="Belt Slot 12"
     FunctionText(93)="Clean Up Debris"
     FunctionText(94)="Attach/Detach Silencer"
     FunctionText(95)="Attach/Detach Scope"
     FunctionText(96)="Attach/Detach Laser Sight"
     FunctionText(97)="Attach/Detach Full Auto Mod"
     FunctionText(98)="Open Console"
     ...
     AliasNames(57)="Flashlight"
     AliasNames(58)="HoldMapF3"
     AliasNames(59)="HoldMapF4"
     AliasNames(60)="HoldMapF5"
     AliasNames(61)="HoldMapF6"
     AliasNames(62)="HoldMapF7"
     AliasNames(63)="HoldMapF8"
     AliasNames(64)="HoldMapF9"
     AliasNames(65)="HoldMapF10"
     AliasNames(66)="HoldMapF11"
     AliasNames(67)="HoldMapF12"
     AliasNames(68)="HoldFlashlight"
     AliasNames(69)="SmartSprint"
     AliasNames(70)="ShowScores"
     AliasNames(71)="TeamTalk"
     AliasNames(72)="Talk"
     AliasNames(73)="BuySkills"
     AliasNames(74)="KillerProfile"
     AliasNames(75)="UseSecondary"
     AliasNames(76)="ToggleRadialAugMenu"
     AliasNames(77)="HoldRadialAugMenu"
     AliasNames(78)="SkipMessages"
     AliasNames(79)="MinimiseTargetingWindow"
     AliasNames(80)="SelectNanoKey"
     AliasNames(81)="AltBelt1"
     AliasNames(82)="AltBelt2"
     AliasNames(83)="AltBelt3"
     AliasNames(84)="AltBelt4"
     AliasNames(85)="AltBelt5"
     AliasNames(86)="AltBelt6"
     AliasNames(87)="AltBelt7"
     AliasNames(88)="AltBelt8"
     AliasNames(89)="AltBelt9"
     AliasNames(90)="AltBelt0"
     AliasNames(91)="AltBelt10"
     AliasNames(92)="AltBelt11"
     AliasNames(93)="CleanUpDebris"
     AliasNames(94)="AttachSilencer"
     AliasNames(95)="AttachScope"
     AliasNames(96)="AttachLaser"
     AliasNames(97)="AttachFullAuto"
     AliasNames(98)="OpenConsole"
