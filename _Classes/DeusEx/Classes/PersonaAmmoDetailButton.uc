...
function SelectButton(Bool bNewSelected)                                        //RSD: Hack to stop ammo load buttons from multiply playing selectbutton sounds
{
    if (bNoSelectSound)
    {
        bSelected = bNewSelected;
        bNoSelectSound = false;
    }
    else
        Super.SelectButton(bNewSelected);
}
