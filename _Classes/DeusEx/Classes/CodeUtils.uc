...
defaultproperties
{
    ...
    ////M05
    codeNotes(40)=(code1="4089",noteName="05_Datacube01")
    codeNotes(41)=(code1="4679",noteName="05_Datacube01")
    codeNotes(42)=(code1="MJ12",code2="INVADER",noteName="05_Datacube02")
    codeNotes(43)=(code1="0199",noteName="05_Datacube03")
    codeNotes(44)=(code1="psherman",code2="raven",noteName="05_Datacube03")
    codeNotes(45)=(code1="2971",noteName="05_Datacube04")
    codeNotes(46)=(code1="anavarre",code2="scryspc",noteName="05_Datacube08")
    codeNotes(47)=(code1="ghermann",code2="zeitgeist",noteName="05_Datacube08")
    codeNotes(48)=(code1="jmanderley",code2="knight_killer",noteName="05_Datacube08")
    codeNotes(49)=(code1="jreed",code2="redshoes",noteName="05_Datacube08")
    codeNotes(50)=(code1="jreyes",code2="amigo",noteName="05_Datacube08")
    codeNotes(51)=(code1="scarter",code2="antique",noteName="05_Datacube08")
    codeNotes(52)=(code1="ajacobson",code2="calvo",noteName="05_Datacube08")
    codeNotes(53)=(code1="klloyd","target",noteName="05_Datacube08")
    codeNotes(54)=(code1="2971",noteName="05_Email01")
    codeNotes(55)=(code1="9905",noteName="05_Email10")
    codeNotes(56)=(code1="5239",noteName="05_Email11") //Unused???
    ////M06
    ...
    codeNotes(77)=(code1="1709",noteName="06_Datacube20")
    ////M9
    codeNotes(78)=(code1="jallred",code2="Apple",noteName="08_Datacube01")
    codeNotes(79)=(code1="Alice_Priest",code2="Secretary",noteName="08_Datacube01")
    ////M10
    codeNotes(80)=(code1="71324",noteName="09_Datacube02")
    codeNotes(81)=(code1="65678",noteName="09_Datacube03")
    codeNotes(82)=(code1="83353",noteName="09_Datacube04")
    codeNotes(83)=(code1="4453",noteName="09_Datacube06")
    codeNotes(84)=(code1="9753",noteName="09_Datacube07")
    codeNotes(85)=(code1="2249",noteName="09_Datacube08")
    codeNotes(86)=(code1="0909",noteName="09_Datacube09")
    codeNotes(87)=(code1="root",code2="reindeerflotilla",noteName="09_Datacube10")
    codeNotes(88)=(code1="Walton",code2="Simons",noteName="09_Datacube11")
    codeNotes(89)=(code1="USFema",code2="Security",noteName="09_Datacube12")
    codeNotes(90)=(code1="KZhao",code2="Captain",noteName="09_Datacube13")
    codeNotes(91)=(code1="6655",noteName="09_Datacube14")
    ////M11
    codeNotes(92)=(code1="4003",noteName="10_Book09")
    codeNotes(93)=(code1="bduclare",code2="nico_angel",noteName="10_Datacube02")
    codeNotes(94)=(code1="005133",code2="salem008",noteName="10_Datacube03")
    codeNotes(95)=(code1="004418",code2="morbus13",noteName="10_Datacube04")
    codeNotes(96)=(code1="002639",code2="aramis01",noteName="10_Datacube05")
    codeNotes(97)=(code1="001506",code2="naga066",noteName="10_Datacube06")
    codeNotes(98)=(code1="1966",noteName="10_Datacube07")
    codeNotes(99)=(code1="2221969",code2="dullbill",noteName="10_Datacube08")
    codeNotes(100)=(code1="Hela",code2="Ragnarok",noteName="10_Datacube11")
    codeNotes(101)=(code1="rzelazny",code2="shadowjack",noteName="10_Datacube12")
    codeNotes(102)=(code1="1784",noteName="10_Datacube13")
    ////M12
    codeNotes(103)=(code1="meverett",code2="pynchon",noteName="11_Datacube01")
    codeNotes(104)=(code1="8001",noteName="11_Datacube02")
    codeNotes(105)=(code1="1942",noteName="11_Datacube03")
    codeNotes(106)=(code1="0022",noteName="11_Datacube03")
    codeNotes(107)=(code1="34501",code2="08711",noteName="11_Datacube03")
    codeNotes(108)=(code1="2384",noteName="11_Email01")
    codeNotes(109)=(code1="6426",noteName="11_Email01")
    codeNotes(110)=(code1="57601",code2="wyrdred03",noteName="11_Book03")
    ////M13
    codeNotes(111)=(code1="Tunnel01",code2="Omega2a",noteName="12_Datacube01")
    ////M15
    codeNotes(112)=(code1="Tech",code2="Sharkman",noteName="14_Datacube01")
    codeNotes(113)=(code1="5690",noteName="14_Datacube02")
    codeNotes(114)=(code1="MJ12",code2="Skywalker",noteName="14_Datacube03")
    codeNotes(115)=(code1="Elder",code2="Armageddon",noteName="14_Datacube05")
    codeNotes(116)=(code1="Oceanguard",code2="Kraken",noteName="14_Datacube06")
    ////M16
    codeNotes(117)=(code1="0169",noteName="15_Datacube01")
    codeNotes(118)=(code1="a51",code2="xx15yz",noteName="15_Datacube07")
    codeNotes(119)=(code1="1038",noteName="15_Datacube08")
    codeNotes(120)=(code1="2242",noteName="15_Datacube09")
    codeNotes(121)=(code1="6765",noteName="15_Datacube11")
    codeNotes(122)=(code1="4225",noteName="15_Datacube12")
    codeNotes(123)=(code1="jshears",code2="momerath",noteName="15_Datacube13")
