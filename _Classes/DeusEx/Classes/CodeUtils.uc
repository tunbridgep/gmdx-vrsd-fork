...
defaultproperties
{
    ...
    codeNotes(45)=(code1="0199",noteName="05_Datacube03")
    codeNotes(46)=(code1="psherman",code2="raven",noteName="05_Datacube03")
    codeNotes(47)=(code1="2971",noteName="05_Datacube04")
    codeNotes(48)=(code1="anavarre",code2="scryspc",noteName="05_Datacube08")
    codeNotes(49)=(code1="ghermann",code2="zeitgeist",noteName="05_Datacube08")
    codeNotes(50)=(code1="jmanderley",code2="knight_killer",noteName="05_Datacube08")
    codeNotes(51)=(code1="jreed",code2="redshoes",noteName="05_Datacube08")
    codeNotes(52)=(code1="jreyes",code2="amigo",noteName="05_Datacube08")
    codeNotes(53)=(code1="scarter",code2="antique",noteName="05_Datacube08")
    ...
    codeNotes(73)=(code1="QUEENSTOWER",code2="SECURITY",noteName="06_Datacube20")
    codeNotes(74)=(code1="FLYBOY",code2="5X5",noteName="06_Datacube23")
    codeNotes(75)=(code1="525",noteName="06_Datacube25")
    codeNotes(76)=(code1="5878",noteName="06_Datacube29")
    ...
    codeNotes(85)=(code1="4453",noteName="09_Datacube06")
    codeNotes(86)=(code1="9753",noteName="09_Datacube07")
    codeNotes(87)=(code1="2249",noteName="09_Datacube08")
    codeNotes(88)=(code1="0909",noteName="09_Datacube09")
    codeNotes(89)=(code1="root",code2="reindeerflotilla",noteName="09_Datacube10")
    codeNotes(90)=(code1="Walton",code2="Simons",noteName="09_Datacube11")
    ...
    codeNotes(97)=(code1="004418",code2="morbus13",noteName="10_Datacube04")
    codeNotes(98)=(code1="002639",code2="aramis01",noteName="10_Datacube05")
    codeNotes(99)=(code1="001506",code2="naga066",noteName="10_Datacube06")
    codeNotes(100)=(code1="1966",noteName="10_Datacube07")
    codeNotes(101)=(code1="2221969",code2="dullbill",noteName="10_Datacube08")
    ...
    codeNotes(108)=(code1="0022",noteName="11_Datacube03")
    ...
    codeNotes(122)=(code1="2242",noteName="15_Datacube09")
    codeNotes(123)=(code1="6765",noteName="15_Datacube11")
    codeNotes(124)=(code1="4225",noteName="15_Datacube12")
    codeNotes(125)=(code1="jshears",code2="momerath",noteName="15_Datacube13")
    codeNotes(126)=(code1="area51",code2="bravo13",noteName="15_Datacube17")
    codeNotes(127)=(code1="2001",noteName="15_Datacube19")
    codeNotes(128)=(code1="page",code2="uberalles",noteName="15_Datacube21")

    ///CONVERSATION NOTES now have proper note names
    ///NOTE: FemJC versions are handled automatically
    codeNotes(129)=(code1="0451",noteName="MeetKaplan")
    codeNotes(130)=(code1="JCD",code2="bionicman",noteName="MeetJanice")
    codeNotes(131)=(code1="JCD",code2="bionicman",noteName="Prebriefing")
    codeNotes(132)=(code1="9183",noteName="MeetJosh")
    codeNotes(133)=(code1="2153",noteName="Doctor1Barter")
