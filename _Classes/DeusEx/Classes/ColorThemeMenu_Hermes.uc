//=============================================================================
// ColorThemeMenu_Hermes
//=============================================================================

class ColorThemeMenu_Hermes extends ColorThemeMenu;
...
defaultproperties
{
    themeName="Hermes"
    bSystemTheme=True
    Colors(0)=(R=150,G=255,B=220)
    Colors(1)=(R=150,G=255,B=220)
    Colors(2)=(R=230,G=195,B=65)
    Colors(3)=(R=75,G=125,B=110)
    Colors(4)=(R=230,G=195,B=65)
    Colors(5)=(R=255,G=255,B=255)
    Colors(6)=(R=175,G=150,B=30)
    Colors(7)=(R=255,G=255,B=255)
    Colors(8)=(R=230,G=195,B=65)
    Colors(9)=(R=255,G=255,B=255)
    Colors(10)=(R=230,G=195,B=65)
    Colors(11)=(R=255,G=255,B=255)
    Colors(12)=(R=230,G=195,B=65)
