...
class ColorThemeMenu_SplinterCell extends ColorThemeMenu;
...
defaultproperties
{
    ...
    Colors(2)=(R=0,G=200,B=0)
    Colors(3)=(R=40,G=40,B=40)
    Colors(4)=(R=0,G=150,B=0)
    Colors(5)=(R=0,G=255,B=0)
    Colors(6)=(R=0,G=48,B=0)
    Colors(7)=(R=0,G=175,B=0)
    Colors(8)=(R=0,G=175,B=0)
    Colors(9)=(R=0,G=255,B=0)
