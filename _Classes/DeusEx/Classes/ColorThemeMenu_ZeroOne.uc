//=============================================================================
// ColorThemeMenu_ZeroOne
//=============================================================================

class ColorThemeMenu_ZeroOne extends ColorThemeHUD;
...
defaultproperties
{
    themeName="Zero-One"
    bSystemTheme=True
    Colors(0)=(R=51,G=18,B=112,A=0)
    Colors(1)=(R=51,G=18,B=112,A=0)
    Colors(2)=(R=0,G=255,B=0,A=0)
    Colors(3)=(R=10,G=10,B=10,A=0)
    Colors(4)=(R=150,G=45,B=0,A=0)
    Colors(5)=(R=0,G=255,B=0,A=0)
    Colors(6)=(R=10,G=10,B=10,A=0)
    Colors(7)=(R=175,G=50,B=0,A=0)
    Colors(8)=(R=200,G=60,B=0,A=0)
    Colors(9)=(R=0,G=255,B=0,A=0)
