...
// LDDPParisClubGuy.
//=============================================================================
class LDDPParisClubGuyS extends HumanCivilian;

defaultproperties
{
     CarcassType=Class'LDDPParisClubGuySCarcass'
     ...
     BindName="LDDPParisClubGuy"
     FamiliarName="Dancing Man"
     UnfamiliarName="Dancing Man"
}
