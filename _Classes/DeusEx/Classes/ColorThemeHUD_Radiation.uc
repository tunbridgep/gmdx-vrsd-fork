//=============================================================================
// ColorThemeHUD_Radiation
//=============================================================================

class ColorThemeHUD_Radiation extends ColorThemeHUD;
...
defaultproperties
{
    ...
    Colors(3)=(R=0,G=107,B=0,A=0)
    Colors(4)=(R=161,G=201,B=0,A=0)
    Colors(5)=(R=255,G=255,B=0,A=0)
    Colors(6)=(R=72,G=83,B=0,A=0)
    Colors(7)=(R=137,G=255,B=0,A=0)
    Colors(8)=(R=255,G=255,B=0,A=0)
    Colors(9)=(R=255,G=255,B=0,A=0)
    Colors(10)=(R=0,G=0,B=0,A=0)
    Colors(11)=(R=0,G=255,B=0,A=0)
    Colors(12)=(R=0,G=255,B=0,A=0)
    Colors(13)=(R=88,G=175,B=0,A=0)
}
