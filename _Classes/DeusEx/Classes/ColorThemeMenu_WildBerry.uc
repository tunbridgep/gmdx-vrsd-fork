//=============================================================================
// ColorThemeMenu_WildBerry
//=============================================================================

class ColorThemeMenu_WildBerry extends ColorThemeMenu;
...
defaultproperties
{
    ...
    Colors(1)=(R=75,G=0,B=255)
    Colors(2)=(R=0,G=200,B=200)
    Colors(3)=(R=75,G=0,B=255)
    Colors(4)=(R=0,G=150,B=150)
    Colors(5)=(R=0,G=255,B=255)
    Colors(6)=(R=0,G=48,B=48)
    Colors(7)=(R=0,G=175,B=175)
    Colors(8)=(R=0,G=175,B=175)
    Colors(9)=(R=0,G=255,B=255)
    Colors(10)=(R=15,G=0,B=50)
    Colors(11)=(R=65,G=0,B=220)
