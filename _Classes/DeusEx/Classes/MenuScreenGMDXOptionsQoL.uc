...
defaultproperties
{
     items(0)=(HelpText="Enable a free cursor in the augmentation wheel, rather than being locked to a circular motion.",actionText="Augmentation Wheel: Free Cursor",variable="bAugWheelFreeCursor",defaultValue=1,bAdvancedModeOnly=true);
     ...
     items(2)=(HelpText="Automatically Add Augmentations to the Wheel when acquired. Augmentations can always be added or removed using middle-click in the Augmentation window.",actionText="Augmentation Wheel: Auto Add Augs.",variable="iAugWheelAutoAdd",defaultValue=1,valueText1="Active Augs Only",valueText2="All Augs",bAdvancedModeOnly=true);
     ...
     items(10)=(HelpText="Adjust the Field-of-View during dialog scenes to more closely match the original game.",actionText="Conversations: FOV Adjustment",variable="iCutsceneFOVAdjust",valueText1="75 FOV",valueText2="80 FOV",valueText3="85 FOV",valueText4="90 FOV",defaultValue=2,bAdvancedModeOnly=true);
     items(11)=(HelpText="Enable Subtitles in full-screen cinematics. This is independent of the regular Subtitles setting.",actionText="Conversations: Subtitles",variable="bSubtitlesCutscene",defaultValue=1,bAdvancedModeOnly=true);
     items(12)=(HelpText="Smooths out the lip-synching animations in conversations. Setting it to 'chunky' intentionally removes blending.",actionText="Conversations: Improved Lip Synch",variable="iEnhancedLipSync",defaultValue=1,valueText2="Chunky",bAdvancedModeOnly=true);
     items(13)=(HelpText="Use the number keys to select dialog choices.",actionText="Conversations: Numbered Replies",variable="bNumberedDialog",defaultValue=1,bAdvancedModeOnly=true);
     items(14)=(HelpText="Show Credits Balance in the Dialog Window.",actionText="Conversations: Show Credits",variable="bCreditsInDialog",defaultValue=1,bAdvancedModeOnly=true);
     ...
     items(16)=(HelpText="If enabled, blood pools will always be the same size for humans. Otherwise it's dependent on carcass size, which is somewhat arbitrary.",actionText="Game: Consistent Blood Pools",variable="bConsistentBloodPools",defaultValue=1,bAdvancedModeOnly=true);
     ...
     items(18)=(HelpText="If enabled, the game will return to the menu after dying, as in Vanilla.",actionText="Game: Death returns to menu",variable="bMenuAfterDeath",bAdvancedModeOnly=true);
     items(19)=(HelpText="If enabled, characters (including the player) will blink randomly.",actionText="Game: Enable Blinking",variable="bEnableBlinking",defaultValue=1,bAdvancedModeOnly=true);
     ...
     items(21)=(HelpText="In Restricted mode, Combat Music will require at least 2 enemies to be in combat before music plays.",actionText="Audio: Play Combat Music",variable="iAllowCombatMusic",defaultValue=1,valueText2="Restricted",bAdvancedModeOnly=true);
     ...
     items(27)=(HelpText="Change weapon viewmodels to display better at high FOV (110+).",actionText="HUD: Alternate Weapon Offsets",variable="iEnhancedWeaponOffsets",defaultValue=1,valueText1="Automatic",valueText2="Always",bAdvancedModeOnly=true);
     items(28)=(HelpText="Display CLIPS or MAGS in the Ammo window. Has no effect for weapons that don't use magazines, or if Accurate Ammo Display is turned on.",actionText="HUD: Ammo Text Display",variable="bDisplayClips",valueText0="MAGS",valueText1="CLIPS",defaultValue=0,bAdvancedModeOnly=true);
     ...
     items(30)=(HelpText="Alternative tool display window with some minor text and spacing changes.",actionText="Tool Windows: Alternative Layout",variable="iAltFrobDisplay",valueText1="Indented",valueText2="Extended",defaultValue=1,bAdvancedModeOnly=true);
     ...
     items(32)=(HelpText="Enable alternate visuals for the bioenergy bar.",actionText="HUD: Animated Bioenergy Bar",variable="bAnimBar1",defaultValue=1,bAdvancedModeOnly=true);
     items(33)=(HelpText="Enable alternate visuals for the stamina bar.",actionText="HUD: Animated Stamina Bar",variable="bAnimBar2",defaultValue=1,bAdvancedModeOnly=true);
     items(34)=(HelpText="Automatically minimise the Targeting augmentation when your hands are empty.",actionText="HUD: Auto-Minimise Targeting",variable="bOnlyShowTargetingWindowWithWeaponOut",defaultValue=1,bAdvancedModeOnly=true);
     items(35)=(HelpText="If Enabled, alternate ammo is color-coded in the toolbelt.",actionText="HUD: Color Coded Ammo",variable="bColorCodedAmmo",defaultValue=1,bAdvancedModeOnly=true);
     ...
     items(37)=(HelpText="Breakable objects display hitpoints & throwable objects display mass. Not recommended for the sake of consistency.",actionText="HUD: Extra Object Details",variable="bExtraObjectDetails",bAdvancedModeOnly=true);
     items(38)=(HelpText="Spy Drone View will use the main camera, with the picture-in-picture window for the Player's view",actionText="HUD: Fullscreen Drone View",variable="bBigDroneView",defaultValue=1,bAdvancedModeOnly=true);
     items(39)=(HelpText="If enabled, a marker appears within your crosshair when dealing damage.",actionText="HUD: Hit Markers",variable="bHitMarkerOn",defaultValue=1,bAdvancedModeOnly=true);
     items(40)=(HelpText="Keypads will display a Clear and Backspace key in place of * and #. Asterisk, Hash, Backspace and Delete are all still available via the keyboard.",actionText="HUD: Keypad Replace Symbols",variable="bReplaceSymbols",consoleTarget="HUDKeypadWindow",defaultValue=1,bAdvancedModeOnly=true);
     items(41)=(HelpText="Keypads will display numbers as they are entered, instead of just dots.",actionText="HUD: Keypad Digit Display",variable="bDigitDisplay",consoleTarget="HUDKeypadWindow",defaultValue=1,bAdvancedModeOnly=true);
     ...
     items(43)=(HelpText="Display Lockpicking/Bypassing tooltips with yellow text if you only just meet the tool requirement, and red text if you don't meet the requirement.",actionText="Tool Windows: Tool Quantity Coloring",variable="bToolWindowShowQuantityColours",defaultValue=1,bAdvancedModeOnly=true);
     items(44)=(HelpText="When displaying the Tool window, show how many tools or lockpicks you have on the panel.",actionText="Tool Windows: Tool Display Style",variable="iFrobDisplayStyle",defaultValue=1,valueText0="Original",valueText1="Current/Required Tools",valueText2="Required/Current Tools");
     ...
     items(53)=(HelpText="If enabled, right clicking a corpse for the first time will never pick it up, to stop accidentally picking up corpses while searching for items.",actionText="Interaction: Enhanced Carcass Searching",variable="bEnhancedCorpseInteractions",defaultValue=1,bAdvancedModeOnly=true);
     ...
     items(55)=(HelpText="Append item counts to item pickup text, if more than 1 item is in the stack.",actionText="Interaction: Show Item Count Labels",variable="bShowItemPickupCounts",defaultValue=1,bAdvancedModeOnly=true);
     items(56)=(HelpText="Append [Searched] text to corpses and show a blue border when they are interacted with.",actionText="Tool Windows: Show Carcass Searched State",variable="iSearchedCorpseText",valueText1="Text Only",valueText2="Border Only",valueText3="Border and Text",defaultValue=3,bAdvancedModeOnly=true);
     ...
     items(58)=(HelpText="Loot will not be declined from corpses if the Walk/Run key is held.",actionText="Interaction: Smart Declining",variable="bSmartDecline",defaultValue=1,bAdvancedModeOnly=true);
     items(59)=(HelpText="When using a medical bot, automatically switch to the Health screen after using the last Aug canister.",actionText="Interaction: Medbot Auto Switch",variable="bMedbotAutoswitch",defaultValue=1,bAdvancedModeOnly=true);
     ...
     items(61)=(HelpText="If Enabled, music will not restart upon map changes using the same track. Extended mode also stops conversation and combat music in bars and clubs.",actionText="Audio: More Immersive Music",variable="iEnhancedMusicSystem",valueText2="Extended",defaultValue=1,bAdvancedModeOnly=true);
     items(62)=(HelpText="Enable/disable level transition autosaving.",actionText="Player: Autosave on Level Change",variable="bTogAutoSave",defaultValue=1,bAdvancedModeOnly=true);
     ...
     items(72)=(HelpText="If enabled, the Items Received window will be shown when looting partial ammo counts from weapons or ammo pickups without picking them up.",actionText="HUD: Show Items Window When Looting Ammo",variable="bAlwaysShowReceivedItemsWindow",defaultValue=1)
     items(73)=(HelpText="If enabled, the maximum number of a given item type will be shown on the inventory icon, instead of just the count.",actionText="HUD: Show Max Stacks",variable="iShowTotalCounts",defaultValue=1,valueText1="Limited",valueText2="Everything",bAdvancedModeOnly=true)
     items(74)=(HelpText="If enabled, Data Cubes will display images as they are read.",actionText="HUD: Data Cubes Show Images",variable="bShowDataCubeImages",defaultValue=1,bAdvancedModeOnly=true)
     //items(74)=(HelpText="If enabled, selecting an item that isn't on the toolbelt will clear the primary selection, allowing right-click to reselect it. Only applies to the Invisible War Toolbelt.",actionText="Belt: Auto-Clear Primary Selection",variable="bAllowSelectingOffAdvBelt",defaultValue=1,bAdvancedModeOnly=true)
     ...
     items(76)=(HelpText="If enabled, the intro and ending cutscenes will play at preset volume ratios.",actionText="Game: Intro/Outro Volume Equalisation",variable="bCutsceneVolumeEqualiser",defaultValue=1,bAdvancedModeOnly=true)
     ...
     items(78)=(HelpText="When active, left-clicking on doors, crates, windows and other interactive items while holstered will select the appropriate tool or melee weapon.",actionText="Interaction: Left-Click Interactions",variable="bEnableLeftFrob",defaultValue=1,bAdvancedModeOnly=true)
     ...
     items(80)=(HelpText="If Enabled, a smaller version of the messages window will display while an infolink is playing.",actionText="HUD: Enable Log during Infolinks",variable="bShowSmallLog",bAdvancedModeOnly=true)
     items(81)=(HelpText="When playing at certain resolutions, the outer crosshairs may become misaligned with the central crosshair. Use this setting to correct it.",actionText="HUD: Crosshair Adjustment",variable="iCrosshairOffByOne",bAdvancedModeOnly=true)
     ...
     items(84)=(HelpText="If enabled, pressing the Run key while crouched will automatically uncrouch. Does nothing when Always Run is enabled.",actionText="Game: Auto Uncrouch",variable="bAutoUncrouch",defaultValue=1,bAdvancedModeOnly=true);
     items(85)=(HelpText="If enabled, always show the Playthrough Modifiers screen before the New Game screen.",actionText="Game: Always Show Playthrough Modifiers",variable="bAlwaysShowModifiers",defaultValue=1,bAdvancedModeOnly=true);
     items(86)=(HelpText="If enabled, right- and middle-clicking in the inventory and augmentations screens will effect the item under the cursor, rather than the currently selected item.",actionText="HUD: Enhanced Inventory/Aug Interaction",variable="bEnhancedPersonaScreenMouse",defaultValue=1,bAdvancedModeOnly=true);
     items(87)=(HelpText="If enabled, keypads and computer login screens will show a list of valid codes from your notes.",actionText="HUD: Show Code Notes",variable="bShowCodeNotes",defaultValue=1,bAdvancedModeOnly=true);
     items(88)=(HelpText="If enabled, the HUD Ammo Display will show total ammo as cyan when at max ammo.",actionText="HUD: Show Max Ammo",variable="bShowFullAmmoInHUD",defaultValue=1,bAdvancedModeOnly=true);
     items(89)=(HelpText="Re-enables the head-popping system from GMDX v9. Not recommended as it looks very unfinished.",actionText="Game: Allow Decapitations",variable="bDecap",defaultValue=0,bAdvancedModeOnly=true);
     items(90)=(HelpText="Alternate display for the accuracy crosshairs. Requires a map load/reload to fully work.",actionText="HUD: Alternate Accuracy Crosshairs",variable="bAlternateCrosshairAcc",bAdvancedModeOnly=true);
     ...
     items(99)=(HelpText="When accessing computers, the Special Options screen will swap the Logout and Email/Security buttons depending on if the computer has any relevant email/security items.",actionText="HUD: Streamlined Computer Interface",variable="bStreamlinedComputerInterface",defaultValue=1,bAdvancedModeOnly=true);
     ...
     items(122)=(HelpText="Picking up a charged item will make a 'hiss' sound if it recharges the last item in the stack, rather than the regular pickup sound. You should leave this enabled.",actionText="Interaction: Charged Item Recharge Sounds",variable="bItemRechargeSound",defaultValue=1,bAdvancedModeOnly=true)
