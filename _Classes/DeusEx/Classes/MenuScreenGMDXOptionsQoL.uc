...
defaultproperties
{
     items(0)=(HelpText="Enable a free cursor in the augmentation wheel, rather than being locked to a circular motion.",actionText="Aug Wheel: Free Cursor",variable="bAugWheelFreeCursor",defaultValue=1);
     items(1)=(HelpText="Enable/Disable the highlighted augmentation when closing the augmentation wheel without requiring left-click. Cancel with right click.",actionText="Aug Wheel: Quick Select",variable="bQuickAugWheel");
     ...
     items(21)=(HelpText="In Restricted mode, Combat Music will require at least 2 enemies to be in combat before music plays.",actionText="Audio: Play Combat Music",variable="iAllowCombatMusic",consoleTarget="DeusEx.MusicPlayer",defaultValue=1,valueText2="Restricted");
     ...
     items(43)=(HelpText="Display Lockpicking/Bypassing tooltips with yellow text if you only just meet the tool requirement, and red text if you don't meet the requirement.",actionText="Tool Windows: Tool Quantity Coloring",variable="bToolWindowShowQuantityColours",defaultValue=1);
     ...
     items(48)=(HelpText="Use smaller fonts for some HUD Elements.",actionText="Fonts: Use Classic Fonts",variable="bClassicFont",consoleTarget="DeusEx.FontManager",defaultValue=1);
     ...
     items(61)=(HelpText="If Enabled, music will not restart upon map changes using the same track. Extended mode also stops conversation and combat music in bars and clubs.",actionText="Audio: More Immersive Music",variable="iEnhancedMusicSystem",valueText2="Extended",consoleTarget="DeusEx.MusicPlayer",defaultValue=1);
     ...
     items(67)=(HelpText="Enable Head bobbing. Three different styles are available. Vanilla is up and down, GMDX9 is realistic and AE is a smoothed version of GMDX9.",actionText="Player: Realistic Head-Bobbing",variable="iModdedHeadBob",defaultValue=3,valueText1="Vanilla",valueText2="GMDX9",valueText3="GMDXAE");
     ...
     items(69)=(HelpText="Prevent accidentally killing vac-bots by stomping on them.",actionText="Player: Stomp Vac Bots",variable="bStompVacbots",defaultValue=0);
     items(70)=(HelpText="Always use the female hands with male JC. This setting does nothing if LDDP is not installed.",actionText="Player: Use Female Hand Textures",variable="bFemaleHandsAlways",defaultValue=0)
     ...
     items(77)=(HelpText="Show darkened versions of ignored and declined items in the Items Received Window when searching carcasses.",actionText="HUD: Show Unlooted in Items Window",variable="bShowDeclinedInReceivedWindow",defaultValue=1)
     ...
     items(95)=(HelpText="Shows a blue border on the tool display window when looking at aug canisters where you can only replace an augmentation, and red when you cannot use the container.",actionText="Tool Windows: Show Aug Canister Status",variable="bToolWindowShowAugState",defaultValue=1);
     ...
     items(99)=(HelpText="When accessing computers, the Special Options screen will swap the Logout and Email/Security buttons depending on if the computer has any relevant email/security items.",actionText="HUD: Streamlined Computer Interface",variable="bStreamlinedComputerInterface",defaultValue=1);
     ...
     items(103)=(HelpText="If enabled, notes added by datacubes, books, etc can be edited in the notes screen. The 'Edit Notes' checkbox must be enabled in order to edit notes.",actionText="HUD: Edit Default Notes",variable="bEditDefaultNotes",defaultValue=1)
     ...
     items(109)=(HelpText="If enabled, the Items Received Window will be cleared when interacting with objects similar to vanilla, rather than appending the new items.",actionText="HUD: Clear Items Received Window",variable="bClearReceivedDisplay",defaultValue=1);
     ...
     items(111)=(HelpText="Dragging items off the inventory grid in the inventory screen will drop the items.",actionText="HUD: Inventory Drag and Drop",variable="bDragAndDropOffInventory",defaultValue=1)
     ...
     items(113)=(HelpText="Immersion/simulation option. If enabled, carried objects are no longer translucent.",actionText="Interaction: Immersive Carryables",variable="bNoTranslucency");
     
     //Version 1.2 Additions
     items(114)=(HelpText="The players Real Name and Appearance will be remembered between playthroughs",actionText="Game: Remember Player Identity",variable="bRememberTheName",defaultValue=1)
     items(115)=(HelpText="Use more readable fonts for most UI elements.",actionText="Fonts: More Readable Fonts",variable="bDXRandoFonts",consoleTarget="DeusEx.FontManager",defaultValue=1)
     items(116)=(HelpText="Use a larger font for Datacubes, Books and other readable objects",actionText="Fonts: Big Reading Font",variable="bBigDatacubeFont",consoleTarget="DeusEx.FontManager",defaultValue=1)
     items(117)=(HelpText="Use a larger font for the Console. Requires the More Readable fonts option enabled.",actionText="Fonts: Big Console Font",variable="iBigConsoleFont",consoleTarget="DeusEx.FontManager",defaultValue=1,valueText1="2x",valueText2="3x")
     items(118)=(HelpText="Using the Scope key with no item equipped will use any Binoculars in your inventory",actionText="Interaction: Smart Binocular Selection",variable="iSmartBinocs",defaultValue=1,valueText2="Select and Activate")
     items(119)=(HelpText="Show your current goals on the HUD",actionText="HUD: Display Goals",variable="bShowGoalsOnScreen",defaultValue=1)
     items(120)=(HelpText="Show pinned notes on the HUD",actionText="HUD: Display Pinned Notes",variable="bShowPinnedNotesOnScreen",defaultValue=1)
     items(121)=(HelpText="Right clicking pickups while the Walk/Run key is held will allow you to carry them around similar to boxes and other decoration items.",actionText="Interaction: Allow Carrying Pickups",variable="bAllowItemPickup",defaultValue=1)
     items(122)=(HelpText="Picking up a charged item will make a 'hiss' sound if it recharges the last item in the stack, rather than the regular pickup sound. You should leave this enabled.",actionText="Audio: Charged Item Recharge Sounds",variable="bItemRechargeSound",defaultValue=1)
     items(123)=(HelpText="Randomizes the skins of junk food, sofas, etc around the world. If disabled they will use preset skins. Takes effect on loading a new map.",actionText="Game: Randomized Object Skins",variable="bRandomizeCrap",defaultValue=1)
     items(124)=(HelpText="Shows icons for map exits.",actionText="Game: Show Map Exits",variable="bShowExits",defaultValue=0)
     items(125)=(HelpText="Item icons in the Inventory and Belt will reflect item skins. Otherwise the default icon is used.",actionText="HUD: Show Skinned Icons",variable="bSkinnedBeltIcons",defaultValue=1)
     items(126)=(HelpText="Enable or Disable smart texture filtering, which will filter only level and item textures while leaving decals, shadows and other elements filtered.",actionText="Game: Texture Filtering",variable="bSmartTextureFiltering",consoleTarget="DeusEx.TextureFilterer",defaultValue=1)
     items(127)=(HelpText="Items on the Augmentation Wheel will always be in preset positions, for maintaining muscle memory.",actionText="Aug Wheel: Preset Positions",variable="bAugWheelPresetPositions",defaultValue=0)
     ...
     items(129)=(HelpText="The players weapon will be moved backwards when up against a wall.",actionText="Game: Weapon Wall Detection",variable="iWeaponWallDistance",realValue1=1000,realValue2=504,valueText2="GMDX v9",defaultValue=2)
     items(130)=(HelpText="Use vanilla-scaled HDTP-Style blood textures when not using HDTP.",actionText="Game: Enhanced Vanilla Blood Textures",variable="bNewBlood",defaultValue=1)
     ...
     items(132)=(HelpText="Show rain and other weather effects. Dynamic mode adjusts the weather dynamically to simulate weather changes.",actionText="Game: Weather Effects",variable="iWeatherControl",defaultValue=1,valueText2="Dynamic (Untested!)")
     ...
     items(147)=(HelpText="If enabled, selecting weapons will shake the screen slightly. This effect was originally used for the Sawed Off Shotgun in Vanilla, but now it's been extended to everything.",actionText="Game: Weapon Selection Screen Shake",variable="bWeaponSelectShake")
