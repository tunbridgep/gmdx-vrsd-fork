...
defaultproperties
{
     ...
     items(146)=(HelpText="If enabled, selecting weapons will shake the screen slightly. This effect was originally used for the Sawed Off Shotgun in Vanilla, but now it's been extended to everything.",actionText="Game: Weapon Selection Screen Shake",variable="bWeaponSelectShake")
