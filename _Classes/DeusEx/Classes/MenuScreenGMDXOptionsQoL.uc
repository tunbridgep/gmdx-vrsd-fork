...
defaultproperties
{
     ...
     items(8)=(HelpText="Keyring is selected when left-clicking on locked doors. Belt slot 0 is made available to general items.",actionText="Belt: Smart Keyring",variable="bSmartKeyring");
