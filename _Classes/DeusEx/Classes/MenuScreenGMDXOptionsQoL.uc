...
defaultproperties
{
     ...
     items(14)=(HelpText="If enabled, characters (including the player) will blink randomly.",actionText="Game: Enable Blinking",variable="bEnableBlinking",defaultValue=1);
  	 items(49)=(HelpText="If enabled, walking or crouching stance will be displayed on player hud.",actionText="Player: Current Stance Display",variable="iStanceHud",valueText1="Walk Stance",valueText2="Walk and Crouch",defaultValue=0);
