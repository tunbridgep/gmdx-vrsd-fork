...
defaultproperties
{
     ...
     items(77)=(HelpText="Show Ignored and Declined Items in the Received Window when searching carcasses.",actionText="HUD: Show Declined in Items Received Window",variable="bShowDeclinedInReceivedWindow")
