...
defaultproperties
{
     ...
     items(6)=(HelpText="Adjust the Field-of-View during dialog scenes to more closely match the original game.",actionText="Conversations: FOV Adjustment",variable="bCutsceneFOVAdjust",defaultValue=1);
     items(7)=(HelpText="Enable Subtitles in full-screen cinematics. This is independent of the regular Subtitles setting.",actionText="Conversations: Subtitles",variable="bSubtitlesCutscene",defaultValue=1);
     items(8)=(HelpText="Use the number keys to select dialog choices.",actionText="Conversations: Numbered Replies",variable="bNumberedDialog",defaultValue=1);
     items(9)=(HelpText="Show Credits Balance in the Dialog Window.",actionText="Conversations: Show Credits",variable="bCreditsInDialog",defaultValue=1);
     items(10)=(HelpText="Use selected HUD Theme in dialog menus.",actionText="Conversations: Use HUD Colours",variable="bDialogHUDColors");
     items(11)=(HelpText="If enabled, the intro cutscene is not loaded.",actionText="Game: Skip Intro",variable="bSkipNewGameIntro");
     items(12)=(HelpText="In Restricted mode, Combat Music will require at least 2 enemies to be in combat before music plays.",actionText="Game: Play Combat Music",variable="iAllowCombatMusic",defaultValue=1,valueText2="Restricted",);
     ...
     items(24)=(HelpText="When displaying the Tool window, show how many tools or lockpicks you have on the panel.",actionText="HUD: Tool Window Style",variable="iFrobDisplayStyle",defaultValue=1,valueText0="Original",valueText1="Current/Required Tools",valueText2="Required/Current Tools");
     items(25)=(HelpText="Modified weapons will have a '+' added to their name in the belt and inventory screens.",actionText="HUD: Show Modified Weapons",variable="bBeltShowModified");
     items(26)=(HelpText="If enabled, the crosshair will turn blue when attempting to attach a mine to a surface.",actionText="HUD: Wall Placement Helper",variable="bWallPlacementCrosshair",defaultValue=1);
     items(27)=(HelpText="If Enabled, attempting to pick up carryable objects will automatically holster your held weapon, enabling you to pick up the object.",actionText="Interaction: Auto-Holster",variable="bAutoHolster");
     items(28)=(HelpText="If enabled, you never retrieve combat knives from corpses.",actionText="Interaction: Decline Knives",variable="bNoKnives");
     items(29)=(HelpText="If enabled, double-right click to holster/unholster items in hand. Prevents accidentally putting away items when attempting to interact with the world.",actionText="Interaction: Double-Click Holstering",variable="bDblClickHolster");
     items(30)=(HelpText="If enabled, right clicking a corpse for the first time will never pick it up, to stop accidentally picking up corpses while searching for items.",actionText="Interaction: Enhanced Looting",variable="bEnhancedCorpseInteractions",defaultValue=1);
     items(31)=(HelpText="Append [Searched] text to corpses when they are interacted with.",actionText="Interaction: Show Searched Labels",variable="bSearchedCorpseText");
     items(32)=(HelpText="Changes lighting on some maps to reduce strobing and flickering.",actionText="Lighting: Lighting Accessibility",variable="bLightingAccessibility");
     items(33)=(HelpText="When dying, switch to a first or third person camera.",actionText="Player: Death Perspective",variable="bRemoveVanillaDeath",valueText0="Third Person",valueText1="First Person");
     items(34)=(HelpText="Alternate realistic headbobbing effect. To disable headbobbing outright, see the standard Settings menu.",actionText="Player: Realistic Head-Bobbing",variable="bModdedHeadBob",defaultValue=1);
