...
defaultproperties
{
     ...
     items(139)=(HelpText="If enabled, lockpicks and other pickups will appear smaller on the screen. Otherwise they will appear larger, which some players may prefer.",actionText="HUD: Smaller Tools",variable="bPickupsUseFOV",defaultValue=1)
