...
event InitWindow()
{
    ...
    default.bLessSkillPoints=false;                                             //Sarge
...
function ProcessAction(String actionKey)
{
    ...
    local MenuScreenPlaythroughModifiers modMenu;                               //RSD
...
function SaveSettings()
{
    ...
    player.bLessSkillPoints=bLessSkillPoints;
