...
- Gameplay Changes:
    ...
    - Weapon Mod, Enemy Weapon and Container Randomisation gameplay modifiers now use a seed generated at the start of every playthrough. This means that they can no longer be rerolled by loading a save before a transition to a new map.
